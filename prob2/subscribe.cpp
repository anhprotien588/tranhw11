...
#define TOPIC       "anhprotien588/feeds/control-led"
#define AUTHMETHOD  "anhprotien588"
#define AUTHTOKEN   "aio_yTMO687Nzmyb7pZpjK8SSrlncC1M"
#define QOS         1
...
int msgarrvd(void *context, char *topicName, int topicLen, MQTTClient_message *message) {
    ...
    string value = payloadptr;
    cout << "The LED is turning " << payloadptr << endl;
    value == "ON" ? writeGPIO("value", "1") : writeGPIO("value", "0");
